...
typedef struct
{
    aresta_grafo ***v; // matriz de arestas
    int *est_celulas; //0-livre 1-ocupado
    int *n_voo; //numero de voos numa certa linha da tabela
    hash_func *hfunc;
    sond_func *sfunc;
    int tamanho; //numero de linhas da tabela ocupados 
    int capacidade; //capacidade da tabela
    char **c_origem; //cidade de origem de todos os elementos da linha de um certo indice da tabela
} estrutura;
